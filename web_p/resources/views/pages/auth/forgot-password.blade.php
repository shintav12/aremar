    ...
    $('#form').validate({
        ...
        unhighlight: function(element) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ route('sendEmailRecoveryPassword') }}",
      ...
      <div class="centered-content w-100">
        <div class="centered-div">
          ...
          <div class="px-4 d-flex justify-content-center">
            <div class="card">
              <div class="card-head">
                <div class="main-text">¿Olvidaste tu contraseña?</div>
                <div class="secondary-text">si no, puedes ingresar
              ...
              <div class="content-card">
                <form id="form">
                    ...
                    <div class="form-group">
                        <input name="newpassword" type="password" placeholder="Nueva Clave" class="form-control" />
                    </div>
                    <div class="form-group">
                        <input name="repeatpassword" type="password" placeholder="Repetir Clave" class="form-control" />
                    </div>
