...
<head>
    <meta charset="utf-8" />
    <title>Admin | Joyas Aremar</title>
...
<div class="page-wrapper">
    ...
    <div class="page-footer">
        <div class="page-footer-inner">
            <div class="copyright"> <strong>Copyright &copy; 2020 <a class="copyright" href="#" target="_blank">Kanavant Technologies</a>.</strong> All rights reserved. </div>
        </div>
