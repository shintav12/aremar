                ...
                "aoColumnDefs": [                 
                    ...
                    },
                    {
                        ...
                        "mRender": function (data, type, full) {
                            ...
                            '<a href="{{ route('auth_role_perms') }}/'+data.id+'" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;Permisos</a>'+
                            '<a title="Eliminar" data-id="'+data.id+'" class="btn btn-primary delete"><i class="fa fa-trash"></i></a>';
                        }
                    }
                ],
