                        ...
                        <div class="tab-pane active" id="tab_0">
                            <div class="form-body">
                                <div class="col-xs-12" style="padding: 20px">
                                    ...
                                    <div class="form-group">
                                        <label>Titulo</label>
                                        <input type="text"  class="form-control" name="title"  value="{{$model->title}}" placeholder="Ingrese el campo" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Texto Boton</label>
                                        <input type="text"  class="form-control" name="btn_text" value="{{$model->btn_text}}"  placeholder="Ingrese el campo">
                                    </div>
                                    <div class="form-group">
                                        <label>Link Boton</label>
                                        <input type="text"  class="form-control" name="btn_link" value="{{$model->btn_link}}"  placeholder="Ingrese el campo">
                                    </div>
                                    <div class="form-group">
                                        <label>Subtitulo</label>
                                        <input type="text"  class="form-control" name="subtitle"  value="{{$model->subtitle}}" placeholder="Ingrese el campo" required>
                                    </div>
                                    <div class="form-group">
